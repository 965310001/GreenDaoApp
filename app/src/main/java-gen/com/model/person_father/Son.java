package com.model.person_father;
...
public class Son {
    ...
    public Son(Long id, int age, String name, java.util.Date date, Long fatherId) {
            this.id = id;
            this.age = age;
            this.name = name;
            this.date = date;
    ...
    public Son(int age, String name, java.util.Date date, Long fatherId) {
            this.id = id;
            this.age = age;
            this.name = name;
            this.date = date;
